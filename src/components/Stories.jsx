    ...
    <section id="stories" className="py-16 bg-gradient-to-t from-white to-amber-50/40">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-10">
          <Tilt3D intensity={8}><h2 className="text-3xl md:text-4xl font-bold text-gray-900">Stories of Hope</h2></Tilt3D>
          <Tilt3D intensity={6}><p className="mt-3 text-gray-700">A glimpse of what your generosity creates across Bharat.</p></Tilt3D>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {items.map((it, idx) => (
            <Tilt3D key={idx} hoverZ={22}>
              <article className="overflow-hidden rounded-2xl bg-white border border-black/5 shadow-sm">
